...
public class GameManager : Manager
{
    ...
    private IEnumerator Start()
    {
        ...
        _boss.HealthCompo.OnDeadEvent += HandleBossHealthHalfEvent;
    ...
    private void HandleBossHealthHalfEvent()
    {
        ...
        FadeUI.FadeIn(0, callBack: async () =>
        {
            ...
            FadeUI.FadeOut(1);
            _boss.HealthCompo.OnDeadEvent -= HandleBossHealthHalfEvent;
            _boss.HealthCompo.OnDeadEvent += _boss.Die;
    ...
    public void BeginStep2()
    {
        ...
        _boss.HealthCompo.CurrentHealth = _boss.HealthCompo.MaxHealth;
        PlayerController player = PlayerManager.Instance.Player;
