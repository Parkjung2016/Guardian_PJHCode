...
public class MainUI : MonoSingleton<MainUI>
{
    ...
    private IEnumerator Start()
    {
        ...
        HideInteractionUI();
        _masterSoundSlider.SetValueWithoutNotify(playerData.masterVolume);
        _bgmSoundSlider.SetValueWithoutNotify(playerData.bgmVolume);
        _sfxSoundSlider.SetValueWithoutNotify(playerData.sfxVolume);
    ...
    {
        _skillCoolProgress.DOFillAmount(0, cooldown + .4f).SetEase(Ease.Linear);
    }
